...
USE_AWS_STORAGE = all([AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_S3_BUCKET_NAME])
...
EMAIL_HOST        = "smtp.gmail.com"          # or SendGrid, Amazon SES, …
EMAIL_PORT        = 587
EMAIL_USE_TLS     = True
EMAIL_HOST_USER   = os.getenv("SMTP_USER")    # your real mailbox/login
